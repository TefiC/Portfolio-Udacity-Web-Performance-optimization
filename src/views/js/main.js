...
var pizzaElementGenerator = function(i) {
    ...
    // pizzaContainer.style.width = "33.33%"; //Avoid adding CSS attributes to HTML elements, instead define styles in stylesheet
...
var resizePizzas = function(size) {
    ...
    function determineDx(elem, size) {
        ...
        /*
         * Determines the pizza's size based on the window's width
         * to keep pizzas from overlapping
         */
     ...
     * @param size {number} - Number assigned to a size
     */
    function changePizzaSizes(size) {
        ...
        //dx is the same for all pizza containers, therefore newWidth must be the
        //same for all pizza containers
...
//Took this variable outside of the for loop
